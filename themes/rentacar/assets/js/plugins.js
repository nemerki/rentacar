/*** --------------------------------------------------
				jQuery PLUGINS TAHT WE USE
				--------------------------
1.  jQuery v1.12.4				   - http://jquery.com/
2.  Bootstrap v3.3.7               - http://getbootstrap.com/
3.  Owl Carousel v2.2.1            - https://owlcarousel2.github.io/OwlCarousel2/index.html
4.  TouchSwipe                     - jQuery Plugin version 1.6.18
5.  Clipboard.js v1.6.1            - https://github.com/zenorocha/clipboard.js
6.  jquery.hoverdir.js v1.1.0      - https://tympanus.net/codrops/2012/04/09/direction-aware-hover-effect-with-css3-and-jquery/
7.  Modernizr 2.6.2                - (Custom Build) | MIT & BSD
8.  Select2.js v.4.0.3             - https://select2.github.io/
9.  jQuery UI - v1.12.1            - http://jqueryui.com/
10. jQuery UI Touch Punch 0.2.3    - touch for price ranges (jquery ui slider)
11. Infobox.js                     - https://github.com/googlemaps/v3-utility-library/tree/master/infobox
12. Markerwithlabel.js             - https://github.com/printercu/google-maps-utility-library-v3-read-only/tree/master/markerwithlabel
13. MarkerClusterer.js             - https://github.com/googlemaps/v3-utility-library/tree/master/markerclusterer
14. OverlappingMarkerSpiderfier.js - https://github.com/jawj/OverlappingMarkerSpiderfier
15. jQuery Datepicker              - http://xdsoft.net/jqplugins/datetimepicker/
16. Slick carousel                 - http://kenwheeler.github.io/slick/
17. Rellax.js					   - https://github.com/dixonandmoe/rellax
...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=35f11fc19674e1bc12d8142246fe9efd)
 * Config saved to config.json and https://gist.github.com/35f11fc19674e1bc12d8142246fe9efd
 */
	...
	$.HoverDir.prototype = {
		...
		_getStyle : function( direction ) {
			...
			var fromStyle, toStyle,
				slideFromTop = { left : '0px', top : '-100%', opacity: '1' },
				slideFromBottom = { left : '0px', top : '100%', opacity: '1' },
				slideFromLeft = { left : '-100%', top : '0px', opacity: '1' },
				slideFromRight = { left : '100%', top : '0px', opacity: '1' },
				slideTop = { top : '0px', opacity: '1' },
				slideLeft = { left : '0px', opacity: '1' };
...
(function(){
/*12.  OverlappingMarkerSpiderfier
