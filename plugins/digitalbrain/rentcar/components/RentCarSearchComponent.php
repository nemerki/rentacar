...
class RentCarSearchComponent extends ComponentBase
{
    ...
    public function componentDetails()
    {
        return [
            'name' => 'RentCarSearch',
            'description' => 'Rent Car Search Page Component'
        ];
    }
...
//        $this->page['filterClass'] = 'filterAjaxPagination';
    ...
    protected function listRecords()
    {
        ...
        if (Session::get('homeFilter') == "1") {
            ...
            $model = $model->where('confirm', "1")->where('is_published', '1')->where('is_rent', '1')->orderBy('created_at','DESC');
            if ($ban_id) {
